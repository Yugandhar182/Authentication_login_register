...
<Navbar style="background-color: blue; height:90px; " let:hidden let:toggle>
  <NavBrand href="/">
  </NavBrand>
...
<Dropdown style="position: absolute; top: 10%; left: 50%; width: 20%; margin-left: 500px;height:200px ;" >
  <div slot="header" class="px-12 py-2">
    <span class="block truncate text-sm font-medium" style="color:Violet; font-size:20px; font-weight:bold ; ">Hire Optica</span>
  </div>
  <hr>
